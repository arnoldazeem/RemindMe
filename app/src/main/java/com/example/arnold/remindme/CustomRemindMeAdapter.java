...
import java.util.List;
    ...
    public class CustomRemindMeAdapter extends RecyclerView.Adapter<CustomRemindMeAdapter.ViewHolder> {
        ...
        private List<RemindmeItem> mData;
        private LayoutInflater mInflater;
        private ItemClickListener mClickListener;

        // data is passed into the constructor
        CustomRemindMeAdapter(Context context, List<RemindmeItem> data) {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = mInflater.inflate(R.layout.reminderme_row, parent, false);
